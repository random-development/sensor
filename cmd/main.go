...
func main() {
	...
	// spawn probes and run their goroutines
	internal.RunProbe(internal.MemProbe{}, psBroker, time.Second)
	internal.RunProbe(internal.CPUProbe{}, psBroker, 2*time.Second)
